...
bot = telebot.TeleBot('7653870246:AAH0VUv7XDfyyo5BZUp1eJ3q0kEx_OV99FI')

# Admin user IDs
admin_id = {"1302320722", "5268655042", "7495474613"}
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 240:
                ...
                full_command = f"./aadi {target} {port} {time} 975"
...
def welcome_start(message):
    ...
    response = f'''𝗪𝗲𝗹𝗰𝗼𝗺𝗲 𝘁𝗼 𝗽𝗿𝗲𝗺𝗶𝘂𝗺 𝗳𝗮𝗺𝗶𝗹𝘆 \n {user_name}! \n𝗢𝘄𝗻𝗲𝗿 @Junaidx_16
𝗙𝗼𝗿 𝗱𝗱𝗼𝘀 𝗶𝗻𝗳𝗼𝗿𝗺𝗮𝘁𝗶𝗼𝗻 : /help 
'''
    bot.reply_to(message, response)
